...
I've been exploring [Tangled](https://tangled.org) lately. Tangled is a decentralized, Git-based collaboration layer built on the AT Protocol: you host your own repos (knots), and the ecosystem treats them as first-class, verifiable data stores. If that sounds interesting, the [Tangled site](https://tangled.org) has the overview, docs, and source.
...
Register your knot from the [Tangled knots settings page](https://tangled.org/settings/knots).
